...
export interface TermdockDesktopApi {
  ...
  getUiPreferences(): Promise<{ theme: 'system' | 'default-dark' | 'default-light'; locale: 'zhCN' | 'enUS' }>
  setUiPreferences(input: { theme?: 'system' | 'default-dark' | 'default-light'; locale?: 'zhCN' | 'enUS' }): Promise<{ theme: 'system' | 'default-dark' | 'default-light'; locale: 'zhCN' | 'enUS' }>
  ...
  openProfile(profileId: string, options?: OpenProfileOptions): Promise<WorkspaceSnapshot>
  openProfileFromManager(profileId: string, options?: OpenProfileOptions): Promise<WorkspaceSnapshot>
